...
public class AlarmManagerActivity extends BaseActivity implements View.OnClickListener {
  ...
  /** Alarms RecyclerView **/
  @BindView(R.id.alarms_rv) RecyclerView mAlarmsRv;

  /** Add playlist FAB **/
  @BindView(R.id.add_playlist_fab) FloatingActionButton mAddPlaylistFab;

  /** Add alarm FAB **/
  @BindView(R.id.add_alarm_fab) FloatingActionButton mAddAlarmFab;

  /** Floating Action Menu **/
  @BindView(R.id.alarms_fam) FloatingActionMenu mAlarmsFam;

  /** No alarms TextView **/
  @BindView(R.id.no_alarms_tv) TextView mNoAlarmsTv;

  /** Alarms Service **/
  @Inject IAlarmsService mAlarmsService;
  ...
  private final android.support.design.widget.Snackbar.Callback mCallback =
      new android.support.design.widget.Snackbar.Callback() {
        ...
        @Override public void onShown(android.support.design.widget.Snackbar snackbar) {
        }
      };
   ...
   */
  @Override protected void injectComponent(DiComponent diComponent) {
